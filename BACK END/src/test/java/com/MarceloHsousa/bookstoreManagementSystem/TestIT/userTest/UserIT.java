...
public class UserIT {
    ...
    public void findById_withValidId_returnStatus200(){
        ...
        org.assertj.core.api.Assertions.assertThat(responseBody.getEmail()).isEqualTo("admin@gmail.com");
        org.assertj.core.api.Assertions.assertThat(responseBody.getName()).isEqualTo("admin test");
